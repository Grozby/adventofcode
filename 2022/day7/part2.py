...
if __name__ == "__main__":
    ...
    size_for_update = 3e7 - (7e7 - root_directory.size)
    min_directory_size = float("inf")
    ...
    while len(to_search) != 0:
        ...
        if current_directory.full_name not in checked_directories:
            ...
            if current_directory.size >= size_for_update:
                min_directory_size = min(min_directory_size, current_directory.size)
